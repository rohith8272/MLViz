...
exports.COMMANDS = exports.REGISTRY = exports.SetHaglCommand = void 0;
...
(function (HeadingType) {
    ...
    HeadingType[HeadingType["DEFAULT"] = 2] = "DEFAULT";
...
(function (MavCmd) {
     ...
     * @param7 Empty
     */
    MavCmd[MavCmd["SET_HAGL"] = 43005] = "SET_HAGL";
...
(function (EkfStatusFlags) {
     ...
     */
    EkfStatusFlags[EkfStatusFlags["GPS_GLITCHING"] = 32768] = "GPS_GLITCHING";
    /**
...
(function (PlaneMode) {
     ...
     * LOITER2QLAND
     */
    PlaneMode[PlaneMode["LOITER_ALT_QLAND"] = 25] = "LOITER_ALT_QLAND";
    /**
     * AUTOLAND
     */
    PlaneMode[PlaneMode["AUTOLAND"] = 26] = "AUTOLAND";
...
(function (CopterMode) {
     ...
     * TURTLE
     */
    CopterMode[CopterMode["TURTLE"] = 28] = "TURTLE";
...
(function (SubMode) {
     ...
     * MOTORDETECT
     */
    SubMode[SubMode["MOTORDETECT"] = 20] = "MOTORDETECT";
    /**
     * SURFTRAK
     */
    SubMode[SubMode["SURFTRAK"] = 21] = "SURFTRAK";
...
(function (RoverMode) {
     ...
     * DOCK
     */
    RoverMode[RoverMode["DOCK"] = 8] = "DOCK";
    /**
     * CIRCLE
     */
    RoverMode[RoverMode["CIRCLE"] = 9] = "CIRCLE";
    /**
     * AUTO
     */
...
(function (TrackerMode) {
     ...
     * GUIDED
     */
    TrackerMode[TrackerMode["GUIDED"] = 4] = "GUIDED";
    /**
     * AUTO
     */
 ...
 * landing.
 */
class SetHaglCommand extends common_2.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
        this.command = MavCmd.SET_HAGL;
        this.targetSystem = targetSystem;
        this.targetComponent = targetComponent;
    }
    /**
    ...
    /**
     * Timeout for this data. The flight controller should only consider this data valid within the timeout
     * window.
     *
     * @units s
     */
...
exports.SetHaglCommand = SetHaglCommand;
exports.REGISTRY = {
    150: SensorOffsets,
    151: SetMagOffsets,
    152: MemInfo,
...
exports.COMMANDS = {
    ...
    [MavCmd.SET_HAGL]: SetHaglCommand,
};
