...
import { MavBool, MavProtocolCapability } from './standard';
 ...
 */
export declare enum RebootShutdownAction {
    /**
     * Do nothing.
     */
    'NONE' = 0,
 ...
 * accepted.
 */
export declare enum RebootShutdownConditions {
    /**
 ...
 */
export declare enum MavFuelType {
    /**
 ...
 */
export declare enum VideoStreamEncoding {
    /**
 ...
 */
export declare enum IlluminatorMode {
    /**
 ...
 */
export declare enum IlluminatorErrorFlags {
    /**
 ...
 */
export declare enum HilActuatorControlsFlags {
    /**
...
export declare class MissionCurrent extends MavLinkData {
     ...
     * GCS can use this to track changes to the mission plan type. The same value is returned on mission
     * upload (in the MISSION_ACK).
     */
    missionId: uint32_t;
    /**
     * Id of current on-vehicle fence plan, or 0 if IDs are not supported or there is no fence loaded. GCS
     * can use this to track changes to the fence plan type. The same value is returned on fence upload (in
     * the MISSION_ACK).
     */
    fenceId: uint32_t;
    /**
...
export declare class MissionCount extends MavLinkData {
    ...
    missionType: MavMissionType;
    /**
     * Id of current on-vehicle mission, fence, or rally point plan (on download from vehicle). This field
     * is used when downloading a plan from a vehicle to a GCS. 0 on upload to the vehicle from GCS. 0 if
     * plan ids are not supported. The current on-vehicle plan ids are streamed in `MISSION_CURRENT`,
     * allowing a GCS to determine if any part of the plan has changed and needs to be re-uploaded. The ids
     * are recalculated by the vehicle when any part of the on-vehicle plan changes (when a new plan is
...
export declare class MissionAck extends MavLinkData {
    ...
    missionType: MavMissionType;
    /**
     * Id of new on-vehicle mission, fence, or rally point plan (on upload to vehicle). The id is
     * calculated and returned by a vehicle when a new plan is uploaded by a GCS. The only requirement on
     * the id is that it must change when there is any change to the on-vehicle plan type (there is no
     * requirement that the id be globally unique). 0 on download from the vehicle to the GCS (on download
     * the ID is set in MISSION_COUNT). 0 if plan ids are not supported. The current on-vehicle plan ids
     * are streamed in `MISSION_CURRENT`, allowing a GCS to determine if any part of the plan has changed
...
export declare class CommandAck extends MavLinkData {
    ...
    result: MavResult;
    /**
     * The progress percentage when result is MAV_RESULT_IN_PROGRESS. Values: [0-100], or UINT8_MAX if the
     * progress is unknown.
     * Units: %
     */
    progress: uint8_t;
    /**
     * Additional result information. Can be set with a command-specific enum containing command-specific
     * error reasons for why the command might be denied. If used, the associated enum must be documented
     * in the corresponding MAV_CMD (this enum should have a 0 value to indicate "unused" or "unknown").
     */
...
export declare class HilActuatorControls extends MavLinkData {
     ...
     * Flags bitmask.
     */
    flags: HilActuatorControlsFlags;
}
/**
...
export declare class HomePosition extends MavLinkData {
     ...
     * Used to indicate the heading and slope of the ground. All fields should be set to NaN if an accurate
     * quaternion for both heading and surface slope cannot be supplied.
     */
    q: float[];
    /**
...
export declare class AdsbVehicle extends MavLinkData {
    ...
    flags: AdsbFlags;
    /**
     * Squawk code. Note that the code is in decimal: e.g. 7700 (general emergency) is encoded as binary
     * 0b0001_1110_0001_0100, not(!) as 0b0000_111_111_000_000
     */
    squawk: uint16_t;
}
/**
...
export declare class CameraInformation extends MavLinkData {
    ...
    /**
     * Camera id of a non-MAVLink camera attached to an autopilot (1-6). 0 if the component is a MAVLink
     * camera (with its own component id).
     */
    cameraDeviceId: uint8_t;
}
/**
...
export declare class CameraImageCaptured extends MavLinkData {
    ...
    /**
     * Camera id of a non-MAVLink camera attached to an autopilot (1-6). 0 if the component is a MAVLink
     * camera (with its own component id). Field name is usually camera_device_id.
     */
    cameraId: uint8_t;
    /**
...
export declare class FlightInformation extends MavLinkData {
    ...
    /**
     * Timestamp at takeoff (since system boot). Set to 0 at boot and on arming. Note, field is misnamed
     * UTC.
     * Units: us
     */
 ...
 */
export declare class CameraThermalRange extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
 ...
 */
export declare class FuelStatus extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
    ...
    maximumFuel: float;
    /**
     * Consumed fuel (measured). This value should not be inferred: if not measured set to NaN. NaN: field
     * not provided.
     */
    consumedFuel: float;
    /**
     * Remaining fuel until empty (measured). The value should not be inferred: if not measured set to NaN.
 ...
 * Illuminator status
 */
export declare class IlluminatorStatus extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
     ...
     */
    modeBitmask: IlluminatorMode;
    /**
     * Errors
     */
    errorStatus: IlluminatorErrorFlags;
    /**
     * Illuminator mode
     */
     ...
     * Units: s
     */
    minStrobePeriod: float;
    /**
     * Maximum strobing period in seconds
     * Units: s
     */
    maxStrobePeriod: float;
}
/**
...
export declare class OpenDroneIdLocation extends MavLinkData {
    ...
    longitude: int32_t;
    /**
     * The altitude calculated from the barometric pressure. Reference is against 29.92inHg or 1013.2mb. If
     * unknown: -1000 m.
     * Units: m
     */
 ...
 * This command has location.
 */
export declare class DoReturnPathStartCommand extends CommandLong {
    constructor(targetSystem?: number, targetComponent?: number);
    /**
...
export declare class DoGripperCommand extends CommandLong {
     ...
     * @increment: 1
     */
    get gripperId(): number;
    set gripperId(value: number);
    /**
 ...
 * illuminating the system itself, e.g. an indicator light).
 */
export declare class DoIlluminatorConfigureCommand extends CommandLong {
    constructor(targetSystem?: number, targetComponent?: number);
    /**
     * Mode
     */
     ...
     * @min: 0
     */
    get strobePeriod(): number;
    set strobePeriod(value: number);
    /**
     ...
     * @max: 100
     */
    get strobeDuty(): number;
    set strobeDuty(value: number);
}
/**
 * Request the home position from the vehicle. 	 The vehicle will ACK the command and then emit the
 * HOME_POSITION message.
...
export declare class StartRxPairCommand extends CommandLong {
     ...
     * RC sub type.
     */
    get rcSubType(): number;
    set rcSubType(value: number);
}
/**
 * Request the interval between messages for a particular MAVLink message ID. The receiver should ACK
 * the command and then emit its response in a MESSAGE_INTERVAL message.
...
export declare class SetMessageIntervalCommand extends CommandLong {
     ...
     * used (0/NaN).
     */
    get reqParam6(): number;
    set reqParam6(value: number);
    /**
