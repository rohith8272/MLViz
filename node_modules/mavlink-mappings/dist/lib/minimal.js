...
(function (MavType) {
     ...
     */
    MavType[MavType["GENERIC_MULTIROTOR"] = 43] = "GENERIC_MULTIROTOR";
    /**
     * Illuminator. An illuminator is a light source that is used for lighting up dark areas external to
     * the system: e.g. a torch or searchlight (as opposed to a light source for illuminating the system
     * itself, e.g. an indicator light).
     */
    MavType[MavType["ILLUMINATOR"] = 44] = "ILLUMINATOR";
    /**
     * Orbiter spacecraft. Includes satellites orbiting terrestrial and extra-terrestrial bodies. Follows
     * NASA Spacecraft Classification.
     */
    MavType[MavType["SPACECRAFT_ORBITER"] = 45] = "SPACECRAFT_ORBITER";
    /**
     * A generic four-legged ground vehicle (e.g., a robot dog).
     */
    MavType[MavType["GROUND_QUADRUPED"] = 46] = "GROUND_QUADRUPED";
    /**
     * VTOL hybrid of helicopter and autogyro. It has a main rotor for lift and separate propellers for
     * forward flight. The rotor must be powered for hover but can autorotate in cruise flight. See:
     * https://en.wikipedia.org/wiki/Gyrodyne
     */
    MavType[MavType["VTOL_GYRODYNE"] = 47] = "VTOL_GYRODYNE";
    /**
     * Gripper
     */
    MavType[MavType["GRIPPER"] = 48] = "GRIPPER";
    /**
     * Radio
     */
    MavType[MavType["RADIO"] = 49] = "RADIO";
...
(function (MavModeFlag) {
    ...
    /**
     * 0b00000001 system-specific custom mode is enabled. When using this flag to enable a custom mode all
 ...
 * system (autopilot, cameras, servos, avoidance systems etc.). Components are not required or expected
 * to use IDs with names that correspond to their type or function, but may choose to do so. Using an
 * ID that matches the type may slightly reduce the chances of component id clashes, as, for historical
 * reasons, it is less likely to be used by some other type of component. System integration will still
 * need to ensure that all components have unique IDs. Component IDs are used for addressing messages
 * to a particular component within a system. A component can use any unique ID between 1 and 255
 * (MAV_COMP_ID_ALL value is the broadcast address, used to send to all components). Historically
 * component ID were also used for identifying the type of component. New code must not use component
 * IDs to infer the component type, but instead check the MAV_TYPE in the HEARTBEAT message!
 */
var MavComponent;
(function (MavComponent) {
     ...
     * Radio #1.
     */
    MavComponent[MavComponent["RADIO"] = 110] = "RADIO";
    /**
     * Radio #2.
     */
    MavComponent[MavComponent["RADIO2"] = 111] = "RADIO2";
    /**
     * Radio #3.
     */
    MavComponent[MavComponent["RADIO3"] = 112] = "RADIO3";
    /**
     * Servo #1.
     */
     ...
     * Illuminator
     */
    MavComponent[MavComponent["ILLUMINATOR"] = 243] = "ILLUMINATOR";
    /**
