 ...
 */
var MlrsRadioLinkStatsFlags;
(function (MlrsRadioLinkStatsFlags) {
    /**
     * Rssi values are in negative dBm. Values 1..254 corresponds to -1..-254 dBm. 0: no reception,
     * UINT8_MAX: unknown.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["RSSI_DBM"] = 1] = "RSSI_DBM";
    /**
     * Rx receive antenna. When set the data received on antenna 2 are taken, else the data stems from
     * antenna 1.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["RX_RECEIVE_ANTENNA2"] = 2] = "RX_RECEIVE_ANTENNA2";
    /**
     * Rx transmit antenna. Data are transmitted on antenna 1.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["RX_TRANSMIT_ANTENNA1"] = 4] = "RX_TRANSMIT_ANTENNA1";
    /**
     * Rx transmit antenna. Data are transmitted on antenna 2.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["RX_TRANSMIT_ANTENNA2"] = 8] = "RX_TRANSMIT_ANTENNA2";
    /**
     * Tx receive antenna. When set the data received on antenna 2 are taken, else the data stems from
     * antenna 1.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["TX_RECEIVE_ANTENNA2"] = 16] = "TX_RECEIVE_ANTENNA2";
    /**
     * Tx transmit antenna. Data are transmitted on antenna 1.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["TX_TRANSMIT_ANTENNA1"] = 32] = "TX_TRANSMIT_ANTENNA1";
    /**
     * Tx transmit antenna. Data are transmitted on antenna 2.
     */
    MlrsRadioLinkStatsFlags[MlrsRadioLinkStatsFlags["TX_TRANSMIT_ANTENNA2"] = 64] = "TX_TRANSMIT_ANTENNA2";
})(MlrsRadioLinkStatsFlags = exports.MlrsRadioLinkStatsFlags || (exports.MlrsRadioLinkStatsFlags = {}));
/**
 * RADIO_LINK_TYPE enum.
 */
var MlrsRadioLinkType;
(function (MlrsRadioLinkType) {
    /**
     * Unknown radio link type.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["GENERIC"] = 0] = "GENERIC";
    /**
     * Radio link is HereLink.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["HERELINK"] = 1] = "HERELINK";
    /**
     * Radio link is Dragon Link.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["DRAGONLINK"] = 2] = "DRAGONLINK";
    /**
     * Radio link is RFD900.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["RFD900"] = 3] = "RFD900";
    /**
     * Radio link is Crossfire.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["CROSSFIRE"] = 4] = "CROSSFIRE";
    /**
     * Radio link is ExpressLRS.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["EXPRESSLRS"] = 5] = "EXPRESSLRS";
    /**
     * Radio link is mLRS.
     */
    MlrsRadioLinkType[MlrsRadioLinkType["MLRS"] = 6] = "MLRS";
})(MlrsRadioLinkType = exports.MlrsRadioLinkType || (exports.MlrsRadioLinkType = {}));
/**
 ...
 */
class MlrsRadioLinkStats extends mavlink_1.MavLinkData {
    constructor() {
        super();
        this.targetSystem = 0;
        this.targetComponent = 0;
        this.flags = MlrsRadioLinkStatsFlags[Object.keys(MlrsRadioLinkStatsFlags)[0]];
        this.rxLQRc = 0;
        this.rxLQSer = 0;
        this.rxRssi1 = 0;
        this.rxSnr1 = 0;
...
exports.MlrsRadioLinkStats = MlrsRadioLinkStats;
MlrsRadioLinkStats.MSG_ID = 60045;
MlrsRadioLinkStats.MSG_NAME = 'MLRS_RADIO_LINK_STATS';
MlrsRadioLinkStats.PAYLOAD_LENGTH = 23;
MlrsRadioLinkStats.MAGIC_NUMBER = 14;
MlrsRadioLinkStats.FIELDS = [
    new mavlink_1.MavLinkPacketField('flags', 'flags', 0, false, 2, 'uint16_t', ''),
    ...
    new mavlink_1.MavLinkPacketField('rx_LQ_rc', 'rxLQRc', 4, false, 1, 'uint8_t', 'c%'),
    new mavlink_1.MavLinkPacketField('rx_LQ_ser', 'rxLQSer', 5, false, 1, 'uint8_t', 'c%'),
    new mavlink_1.MavLinkPacketField('rx_rssi1', 'rxRssi1', 6, false, 1, 'uint8_t', ''),
    new mavlink_1.MavLinkPacketField('rx_snr1', 'rxSnr1', 7, false, 1, 'int8_t', ''),
    new mavlink_1.MavLinkPacketField('tx_LQ_ser', 'txLQSer', 8, false, 1, 'uint8_t', 'c%'),
    ...
    new mavlink_1.MavLinkPacketField('rx_rssi2', 'rxRssi2', 11, false, 1, 'uint8_t', ''),
    new mavlink_1.MavLinkPacketField('rx_snr2', 'rxSnr2', 12, false, 1, 'int8_t', ''),
    new mavlink_1.MavLinkPacketField('tx_rssi2', 'txRssi2', 13, false, 1, 'uint8_t', ''),
    new mavlink_1.MavLinkPacketField('tx_snr2', 'txSnr2', 14, false, 1, 'int8_t', ''),
    new mavlink_1.MavLinkPacketField('frequency1', 'frequency1', 15, true, 4, 'float', 'Hz'),
    new mavlink_1.MavLinkPacketField('frequency2', 'frequency2', 19, true, 4, 'float', 'Hz'),
];
/**
 ...
 * the message.
 */
class MlrsRadioLinkInformation extends mavlink_1.MavLinkData {
    constructor() {
        super();
        this.targetSystem = 0;
        this.targetComponent = 0;
        this.type = MlrsRadioLinkType[Object.keys(MlrsRadioLinkType)[0]];
        this.mode = 0;
        this.txPower = 0;
        this.rxPower = 0;
        this.txFrameRate = 0;
        ...
        this.modeStr = '';
        this.bandStr = '';
        this.txSerDataRate = 0;
        this.rxSerDataRate = 0;
        this.txReceiveSensitivity = 0;
        this.rxReceiveSensitivity = 0;
    }
}
exports.MlrsRadioLinkInformation = MlrsRadioLinkInformation;
MlrsRadioLinkInformation.MSG_ID = 60046;
MlrsRadioLinkInformation.MSG_NAME = 'MLRS_RADIO_LINK_INFORMATION';
MlrsRadioLinkInformation.PAYLOAD_LENGTH = 28;
MlrsRadioLinkInformation.MAGIC_NUMBER = 171;
MlrsRadioLinkInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('tx_frame_rate', 'txFrameRate', 0, false, 2, 'uint16_t', 'Hz'),
    new mavlink_1.MavLinkPacketField('rx_frame_rate', 'rxFrameRate', 2, false, 2, 'uint16_t', 'Hz'),
    new mavlink_1.MavLinkPacketField('tx_ser_data_rate', 'txSerDataRate', 4, false, 2, 'uint16_t', ''),
    new mavlink_1.MavLinkPacketField('rx_ser_data_rate', 'rxSerDataRate', 6, false, 2, 'uint16_t', ''),
    ...
    new mavlink_1.MavLinkPacketField('mode', 'mode', 11, false, 1, 'uint8_t', ''),
    new mavlink_1.MavLinkPacketField('tx_power', 'txPower', 12, false, 1, 'int8_t', 'dBm'),
    new mavlink_1.MavLinkPacketField('rx_power', 'rxPower', 13, false, 1, 'int8_t', 'dBm'),
    new mavlink_1.MavLinkPacketField('mode_str', 'modeStr', 14, false, 1, 'char[]', '', 6),
    new mavlink_1.MavLinkPacketField('band_str', 'bandStr', 20, false, 1, 'char[]', '', 6),
    new mavlink_1.MavLinkPacketField('tx_receive_sensitivity', 'txReceiveSensitivity', 26, false, 1, 'uint8_t', ''),
    new mavlink_1.MavLinkPacketField('rx_receive_sensitivity', 'rxReceiveSensitivity', 27, false, 1, 'uint8_t', ''),
];
...
exports.REGISTRY = {
    ...
    60045: MlrsRadioLinkStats,
    60046: MlrsRadioLinkInformation,
};
exports.COMMANDS = {
